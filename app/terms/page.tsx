...
export default function TermsOfService() {
  const sections = [
    ...
    { id: "ugc", title: "9. User Generated Contributions" },
    { id: "license", title: "10. Contribution License" },
    { id: "mobile", title: "11. Mobile Application License" },
    { id: "thirdparty", title: "12. Third-Party Websites and Content" },
    { id: "sitemanage", title: "13. Services Management" },
    { id: "ppyes", title: "14. Privacy Policy" },
    { id: "copyrightyes", title: "15. Copyright Infringements" },
    { id: "terms", title: "16. Term and Termination" },
    { id: "modifications", title: "17. Modifications and Interruptions" },
    { id: "law", title: "18. Governing Law" },
    { id: "disputes", title: "19. Dispute Resolution" },
    { id: "corrections", title: "20. Corrections" },
    { id: "disclaimer", title: "21. Disclaimer" },
    { id: "liability", title: "22. Limitations of Liability" },
    { id: "indemnification", title: "23. Indemnification" },
    { id: "userdata", title: "24. User Data" },
    {
      id: "electronic",
      title: "25. Electronic Communications, Transactions, and Signatures",
    },
    { id: "california", title: "26. California Users and Residents" },
    { id: "misc", title: "27. Miscellaneous" },
    { id: "veterinary", title: "28. Veterinary Disclaimer" },
    { id: "contact", title: "29. Contact Us" },
  ];

  return (
    <>
      <Head>
        <title>Terms of Service - ReactivityTracker</title>
        <meta
          name="description"
          content="Terms of Service for ReactivityTracker - Learn about your rights and obligations when using our services."
        />
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <aside className="lg:w-64 lg:flex-shrink-0">
              <div className="sticky top-8 bg-white rounded-lg shadow-sm border p-6 max-h-screen overflow-y-auto">
              ...
              <div className="p-8">
                ...
                <section id="agreement" className="mb-12">
                  ...
                  <div className="prose max-w-none text-gray-700 leading-relaxed space-y-4">
                    <p>
                      We are Monitum d.o.o (&quot;Company,&quot; &quot;we,&quot;
                      &quot;us,&quot; &quot;our&quot;), a company registered in
                      Croatia at Karamanova 4, Split, Split-Dalmatia County
                      21000. Our VAT number is 42784513142.
                    </p>

                    <p>
                      We operate the website{" "}
                      <a
                        href="http://www.reactivitytracker.com"
                        target="_blank"
                        className="text-blue-600 hover:text-blue-800"
                      >
                        http://www.reactivitytracker.com
                      </a>{" "}
                      (the &quot;Site&quot;), the mobile application
                      ReactivityTracker (the &quot;App&quot;), as well as any
                    ...
                    <p>
                      Reactivity Tracker helps dog owners track their dog&apos;s
                      behavioral triggers and health patterns through daily
                      journaling and data visualisation. The app allows users to
                      log daily observations, identify trigger patterns, monitor
                      progress over time, and export data to share with
                      veterinarians and trainers. Designed specifically for
                      reactive dogs, it transforms scattered observations into
                      actionable insights to improve both dog behavior and
                      health outcomes.
                    </p>

                    <p>
                      You can contact us by phone at +385977378030, email at
                      hello@reactivitytracker.com, or by mail to Karamanova 4,
                    ...
                    <p>
                      ...
                      entity (&quot;you&quot;), and Monitum d.o.o, concerning
                    ...
                    <p>
                      ...
                      by hello@reactivitytracker.com, as stated in the email
                      message. By continuing to use the Services after the
                      effective date of any changes, you agree to be bound by
                      the modified terms.
                    </p>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="text-gray-700 leading-relaxed space-y-4">
                      ...
                      <p>
                        ...
                        hello@reactivitytracker.com. If we ever grant you the
                  ...
                  <div>
                    ...
                    <div className="text-gray-700 leading-relaxed space-y-4">
                      ...
                      <p>
                        ...
                        other users of the Services and possibly through
                      ...
                      <p>
                        ...
                        translate, excerpt (in whole or in part), and exploit
                        your Contributions (including, without limitation, your
                        image, name, and voice) for any purpose, commercial,
                        advertising, or otherwise, to prepare derivative works
                        of, or incorporate into other works, your Contributions,
                        and to sublicense the licenses granted in this section.
                        Our use and distribution may occur in any media formats
                      ...
                      <ul className="list-disc pl-6 space-y-1">
                        <li>
                          ...
                          obscene, bullying, abusive, discriminatory,
                        ...
                        <li>
                          ...
                          grant us the above-mentioned rights in relation to
                      ...
                      <p>
                        ...
                        for any and all losses that we may suffer because of
                        your breach of (a) this section, (b) any third
                  ...
                  <div>
                    ...
                    <div className="text-gray-700 leading-relaxed space-y-4">
                      <p>
                        ...
                        control, please immediately refer to the &quot;COPYRIGHT
                ...
                <section id="userreps" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">
                  ...
                  <div className="text-gray-700 leading-relaxed space-y-4">
                    <p>
                      ...
                      Services for any illegal or unauthorized purpose; and (7)
                ...
                {/* User Registration */}
                <section id="userreg" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">
                    4. USER REGISTRATION
                  </h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        ...
                        below. Your cancellation will take effect at the end of
                ...
                <section id="software" className="mb-12">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    license agreement (&quot;EULA&quot;), the terms of the EULA
                    will govern your use of the software. If such software is
                    not accompanied by a EULA, then we grant to you a
                    ...
                    arising out of use or performance of any software. You may
                    not reproduce or redistribute any software except in
                    software except in accordance with the EULA or these Legal
                    Terms.
                  </p>
                </section>
                ...
                <section id="ugc" className="mb-12">
                  ...
                  <div className="text-gray-700 leading-relaxed space-y-4">
                    <p>
                      ...
                      by other users of the Services and through third-party
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        ...
                        &quot;App Distributor&quot;) to access the Services: (1)
                ...
                <section id="thirdparty" className="mb-12">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    App) links to other websites (&quot;Third-Party
                    ...
                    shall hold us blameless from any harm caused by your
                    purchase of such products or services. Additionally, you
                    shall hold us blameless from any losses sustained by you or
                    harm caused to you relating to or resulting in any way from
                    any Third-Party Content or any contact with Third-Party
                    Websites.
                  </p>
                </section>

                {/* Services Management */}
                <section id="sitemanage" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">
                ...
                {/* Privacy Policy */}
                <section id="ppyes" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">
                    14. PRIVACY POLICY
                  </h2>
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    Privacy Policy:{" "}
                    <a
                      href="http://www.reactivitytracker.com/privacy"
                      target="_blank"
                      className="text-blue-600 hover:text-blue-800 font-semibold"
                    >
                      http://www.reactivitytracker.com/privacy
                    </a>
                    . By using the Services, you agree to be bound by our
                    Privacy Policy, which is incorporated into these Legal
                    Terms. Please be advised the Services are hosted in Croatia
                    and United States. If you access the Services from any other
                    region of the world with laws or other requirements
                    governing personal data collection, use, or disclosure that
                    differ from applicable laws in Croatia and United States,
                    then through your continued use of the Services, you are
                    transferring your data to Croatia and United States, and you
                    expressly consent to have your data transferred to and
                    processed in Croatia and United States.
                  </p>
                </section>

                {/* Copyright Infringements */}
                <section id="copyrightyes" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">
                ...
                <section id="law" className="mb-12">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    the laws of Croatia, and the use of the United Nations
                    ...
                    law in your country to residence. Monitum d.o.o and yourself
                    both agree to submit to the non-exclusive jurisdiction of
                    the courts of Zagreb, which means that you may make a claim
                    to defend your consumer protection rights in regards to
                    these Legal Terms in Croatia, or in the EU country in which
                    you reside.
                  </p>
                </section>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        ...
                        acceptance. The seat of arbitration shall be Zagreb,
                        Croatia. The language of the proceedings shall be
                        English. Applicable rules of substantive law shall be
                        the law of Croatia.
                      </p>
                    </div>
                ...
                <section id="disclaimer" className="mb-12">
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                    <p className="text-gray-800 text-sm leading-relaxed">
                      ...
                      OR COMPLETENESS OF THE SERVICES&apos; CONTENT OR THE
                      ...
                      OR OTHER ADVERTISING, AND WE WILL NOT BE A PARTY TO OR IN
                ...
                {/* User Data */}
                <section id="userdata" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">
                    24. USER DATA
                  </h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <section id="veterinary" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">
                    28. VETERINARY DISCLAIMER
                  </h2>
                  <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                    <p className="text-gray-800 leading-relaxed">
                      This application is for tracking and organizational
                      purposes only. The information provided through this app
                      does not constitute veterinary or medical advice and
                      should not be used as a substitute for professional
                      veterinary consultation, diagnosis, or treatment. Always
                      consult with a qualified veterinarian regarding your
                      pet&apos;s health and behavior concerns. We are not
                      licensed veterinarians and assume no responsibility for
                      any decisions made based on information tracked or
                ...
                <section id="contact" className="mb-8">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <div className="space-y-2 text-gray-800">
                      <div>
                        <strong>Monitum d.o.o</strong>
                      </div>
                      <div>
                        <strong>Karamanova 4</strong>
                      </div>
                      <div>
                        <strong>Split, Split-Dalmatia County 21000</strong>
                      </div>
                      <div>
                        <strong>Croatia</strong>
                      </div>
                      <div className="pt-2">
                        <strong>Phone: +385977378030</strong>
                      </div>
                      <div>
                        <strong>hello@reactivitytracker.com</strong>
                      </div>
                    </div>
                  </div>
                </section>
