          ...
          <div className="flex items-start gap-3 sm:gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4">
                ...
                while others help us analyze usage and provide personalized content.
              </p>
              ...
              {showSettings && (
                <div className="space-y-3 sm:space-y-4 mb-3 sm:mb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <label className="font-medium text-xs sm:text-sm">Necessary Cookies</label>
                      <p className="text-xs text-gray-500 hidden sm:block">Required for the website to function properly</p>
                    </div>
                    <input
                      type="checkbox"
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <label className="font-medium text-xs sm:text-sm">Analytics Cookies</label>
                      <p className="text-xs text-gray-500 hidden sm:block">Help us understand how visitors use our website</p>
                    </div>
                    <input
                      type="checkbox"
              ...
              <div className="flex flex-wrap gap-2">
                {!showSettings ? (
                  <>
                    <Button onClick={handleAcceptAll} size="sm" className="text-xs px-3 py-1 h-8">
                      <span className="hidden sm:inline">Accept All</span>
                      <span className="sm:hidden">Accept</span>
                    </Button>
                    <Button onClick={handleAcceptNecessary} variant="outline" size="sm" className="text-xs px-3 py-1 h-8">
                  ...
                  <>
                    <Button onClick={handleSavePreferences} size="sm" className="text-xs px-3 py-1 h-8">
